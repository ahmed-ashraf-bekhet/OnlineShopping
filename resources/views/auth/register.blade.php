        ...
        <div  class="form-w3agile form1">
            <h3>Register</h3>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="phone-Number" class="col-md-6 col-form-label text-md-right">Phone Number</label>

                            <div class="col-md-6">
                                <input id="phone-Number" type="number" class="form-control mb-3" name="phoneNumber" required>
                            </div>
                        </div>
