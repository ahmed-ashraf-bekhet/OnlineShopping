function autocomplete(inp, arr) {
  ...
  $.ajax({
    ...
    error:function(x,y,z){
        console.log('error')
        alert('Ooh , Your Transcation failed ... Please Try Again');
    }
  });
        ...
        if(element['Name']==$("#myInput").val()){
            ...
            $("#modalBody").html(
				...
				'<div class="col-md-7 span-1 ">'+
                    ...
                    '</div>'+
                    '<div class="add-to">'+
						'<button id="modal_image" class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="'+element['id']+'" data-name="'+element['Name']+'" data-summary="'+element['Description']+'" data-price="'+element['Salary']+'" data-quantity="'+$("#quantity").val()+'" data-image="'+element['Name']+'">Add to Cart</button>'+
					'</div>'+
				'</div>'+
                '<div class="clearfix"> </div>'
            )
